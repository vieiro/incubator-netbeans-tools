...
image:../../images_www/v7/3/features/php/php-ide_top.png[]

link:../html5/index.html[HTML5 Web開発のサポート]・ページの説明のような、HTML5、JavaScriptおよびCSS3開発のための完全サポートを使用した、専用のPHPコーディング環境およびWeb標準との完全統合。

[overview-right]#image:/images_www/v7/3/features/php/php-code-completion_small.png[]#
...
  [overview-left]#image:/images_www/v7/3/features/php/php-54-traitcc_small.png[]#
...
  [overview-right]#image:/images_www/v7/3/features/php/frameworks.png[]#
...
  [overview-left]#image:/images_www/v7/3/features/ide-collaboration-hudson-cut.png[]#
...
  [overview-right]#image:/images_www/v7/3/features/php/php-project.png[]#
...
  [overview-left]#image:/images_www/v7/3/features/php/php-debugger.png[]#
