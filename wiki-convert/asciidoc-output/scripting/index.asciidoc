...
link:../../images_www/v7/1/screenshots/dynamic-languages-big.png[image:../../images_www/v7/1/screenshots/dynamic-languages.png[][font-11]#Click image for fullscreen preview#]
...
A fast and light-weight PHP IDE. |image:../../images_www/v6/arrow-button.gif[]link:../groovy/index.html[Groovy]
Integrate Groovy with Java SE and use the Grails web framework. |image:../../images_www/v6/arrow-button.gif[]link:../javascript/index.html[JavaScript]
