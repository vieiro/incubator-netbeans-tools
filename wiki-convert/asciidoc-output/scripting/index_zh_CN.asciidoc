...
link:../../images_www/v7/1/screenshots/dynamic-languages-big.png[image:../../images_www/v7/1/screenshots/dynamic-languages.png[][font-11]#单击图像查看全屏预览#]
...
快速的小型 PHP IDE。 |image:../../images_www/v6/arrow-button.gif[] link:../groovy/index.html[Groovy]
将 Groovy 与 Java SE 集成，并使用 Grails Web 框架。 |image:../../images_www/v6/arrow-button.gif[] link:../javascript/index.html[JavaScript]
