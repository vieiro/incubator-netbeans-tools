...
link:../../images_www/v7/1/screenshots/dynamic-languages-big.png[image:../../images_www/v7/1/screenshots/dynamic-languages.png[][font-11]#Для перехода к полноэкранному предварительному просмотру щелкните изображение#]
...
Быстрая и облегченная IDE PHP. |image:../../images_www/v6/arrow-button.gif[]link:../groovy/index.html[Groovy]
Интеграция Groovy с Java SE и использование веб-платформы Grails. |image:../../images_www/v6/arrow-button.gif[]link:../javascript/index.html[JavaScript]
