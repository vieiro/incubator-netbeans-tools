...
link:../../images_www/v7/1/screenshots/dynamic-languages-big.png[image:../../images_www/v7/1/screenshots/dynamic-languages.png[][font-11]#Clique na imagem para exibição em tela inteira#]
...
Um PHP IDE rápido e leve. |image:../../images_www/v6/arrow-button.gif[]link:../groovy/index.html[Groovy]
Integrar Groovy com Java SE e usar o framework da web de Grails. |image:../../images_www/v6/arrow-button.gif[]link:../javascript/index.html[JavaScript]
