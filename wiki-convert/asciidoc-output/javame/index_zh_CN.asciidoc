...
link:../../images_www/v7/1/screenshots/gamebuilder.png[image:../../images_www/v7/1/screenshots/gamebuilder-cut.png[][font-11]#单击图像查看全屏预览#]
...
image:../../images_www/v6/arrow-button.gif[] link:../../kb/trails/mobility.html[Mobility 学习资源]

 |link:http://www.ikivo.com/java/java.html[image:../../images_www/partners/ikivo_logo_small.jpg[]] Ikivo Animator：NetBeans IDE 的高级 SVG 图像和动画编辑功能。通过此link:http://www.ikivo.com/java/white_paper1.html[白皮书]和link:http://www.ikivo.com/java/netbeans_tutorial.html[教程]可以了解更多信息。 
|===
