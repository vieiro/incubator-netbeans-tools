...
link:../../images_www/v7/3/features/groovy-full.png[image:groovy-cut.png[][font-11]#Clique na imagem para exibição em tela inteira#]
...
link:../../kb/docs/java/groovy-quickstart.html[Introdução ao Groovy]     [overview-left]#link:../../images_www/v7/3/features/groovy-grails-full.png[image:groovy-grails-cut.png[]]#
...
link:../../kb/docs/web/grails-quickstart.html[Introdução ao Framework do Grails]     [overview-right]#link:../../images_www/v7/3/features/groovy-gradle.png[image:groovy-gradle-cut.png[]]#
