...
link:../../images_www/v7/3/features/ide-database-full.png[image:../../images_www/v7/3/features/ide-database-cut.png[][font-11]#Clique na imagem para exibição em tela inteira#]
...
link:../../kb/docs/ide/mysql.html[Conectando o MySQL Database]     [overview-left]#link:../../images_www/v7/3/features/ide-database-full.png[image:../../images_www/v7/3/features/ide-database-sql.png[]]#
