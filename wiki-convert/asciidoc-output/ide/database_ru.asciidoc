...
link:../../images_www/v7/3/features/ide-database-full.png[image:../../images_www/v7/3/features/ide-database-cut.png[][font-11]#Для перехода к полноэкранному предварительному просмотру щелкните изображение#]
...
    [overview-right]#image:../../images_www/v7/3/features/ide-database-explorer-cut.png[]#
...
link:../../kb/docs/ide/mysql.html[Подключение к базе данных MySQL]     [overview-left]#link:../../images_www/v7/3/features/ide-database-full.png[image:../../images_www/v7/3/features/ide-database-sql.png[]]#
