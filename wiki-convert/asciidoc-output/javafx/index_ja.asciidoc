...
link:../../images_www/v7/1/screenshots/javafx2-main-big.png[image:../../images_www/v7/1/screenshots/javafx2-main.png[][font-11]#イメージをクリックして全画面表示#]
...
|===
|=== JavaFXプロジェクト image:../../images_www/v6/features/new_small.gif[]
...
image:../../images_www/v6/arrow-button.gif[] 詳細は、link:../../kb/docs/java/debug-visual.html[NetBeans IDEでのビジュアル・デバッガの使用]を参照してください。

 |image:../../images_www/v7/1/features/debug-take-snapshot.png[title="「デバッグ」メニューの「GUIスナップショットの取得」オプション"] 
...
|image:../../images_www/v6/arrow-button.gif[] link:http://docs.oracle.com/javafx/index.html[JavaFXドキュメント・ホーム]: ダウンロード、デモ、FAQおよびチュートリアル。
