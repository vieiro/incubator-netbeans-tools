...
link:../../images_www/v6/9/screenshots/javafx-composer.png[image:../../images_www/v6/9/screenshots/javafx-composer-cut.png[][font-11]#单击图像查看全屏预览#]
...
|=== 内置数据连接 image:../../images_www/v6/features/new_small.gif[]
...
image:../../images_www/v6/arrow-button.gif[] link:https://netbeans.org/kb/trails/matisse.html[JavaFX 和 Swing GUI 学习资源]。

image:../../images_www/v6/arrow-button.gif[] 包含下载、演示、常见问题解答和文档的 link:http://www.javafx.com/[javafx.com]。
