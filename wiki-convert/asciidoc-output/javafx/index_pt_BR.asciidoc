...
link:../../images_www/v7/1/screenshots/javafx2-main-big.png[image:../../images_www/v7/1/screenshots/javafx2-main.png[][font-11]#Clique na imagem para exibição em tela inteira#]
...
|===
|=== Projetos JavaFX image:../../images_www/v6/features/new_small.gif[]
...
image:../../images_www/v6/arrow-button.gif[] Consulte link:../../kb/docs/java/debug-visual.html[Usando o Depurador Visual no NetBeans IDE] para obter mais informações.

 |image:../../images_www/v7/1/features/debug-take-snapshot.png[title="Opção Obter Snapshot de GUI do menu Depurar"] 
...
|image:../../images_www/v6/arrow-button.gif[] link:http://docs.oracle.com/javafx/index.html[Home da Documentação JavaFX]: Downloads, demonstrações, FAQs e tutoriais.
