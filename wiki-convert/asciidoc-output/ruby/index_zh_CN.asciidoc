...
link:../../images_www/v6/9/screenshots/ruby.png[image:../../images_www/v6/9/screenshots/ruby-cut.png[][font-11]#单击图像查看全屏预览#]
...
image:../../images_www/v6/arrow-button.gif[] link:http://wiki.netbeans.org/wiki/view/Ruby[Ruby Wiki]

image:../../images_www/v6/arrow-button.gif[] link:http://wiki.netbeans.org/RubySupport[Ruby 支持 Wiki]
