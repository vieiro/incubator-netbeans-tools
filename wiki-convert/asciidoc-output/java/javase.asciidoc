...
link:../../images_www/v7/screenshots/java-se.png[image:../../images_www/v7/screenshots/java-se-cut1.png[][font-11]#Click image for fullscreen preview#]
...
image:../../images_www/v6/arrow-button.gif[] link:../../kb/trails/java-se.html[Basic IDE and Java Programming Learning Trail]
