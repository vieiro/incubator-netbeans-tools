...
link:../../images_www/v7/1/screenshots/debugger.png[image:../../images_www/v7/1/screenshots/debugger-cut.png[][font-11]# Clique na imagem para exibição em tela inteira#]
...
link:../../kb/docs/java/debug-visual.html[Usando o Visual Debugger no NetBeans IDE]     [overview-right]#link:../../images_www/v7/3/features/profiler.png[image:../../images_www/v7/3/features/profiler-cut.png[]]#
