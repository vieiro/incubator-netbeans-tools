...
link:../../images_www/v7/1/screenshots/gui-builder.png[image:../../images_www/v7/1/screenshots/gui-builder-cut.png[][font-11]#单击图像查看全屏预览#]

*创建具备自动调整间距和自动对齐的专业 GUI。*

|===
|=== 专业的 Swing GUI 构建 image:../../images_www/v6/features/improved_small.gif[]
...
|=== 可视调试器 image:../../images_www/v6/features/improved_small.gif[]
...
image:../../images_www/v6/arrow-button.gif[] link:../../kb/trails/matisse.html[GUI 构建器学习资源]
