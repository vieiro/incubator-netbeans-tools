...
link:../../images_www/v7/3/features/ide-buildtools-maven-full.png[image:../../images_www/v7/3/features/ide-buildtools-maven-cut.png[][font-11]#イメージをクリックして全画面表示#]
...
link:https://netbeans.org/kb/articles/freeform-config.html[自由形式プロジェクトの詳細構成]     [overview-left]#link:../../images_www/v7/3/features/groovy-gradle.png[image:../../images_www/v7/3/features/groovy-gradle-cut.png[]]#
