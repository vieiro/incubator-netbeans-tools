...
link:https://netbeans.org/kb/articles/freeform-config.html[自由形式プロジェクトの詳細構成]     [overview-left]#link:../../images_www/v7/3/features/groovy-gradle.png[image:groovy-gradle-cut.png[]]#
