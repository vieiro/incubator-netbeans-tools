...
link:../../images_www/v7/3/features/ide-findbugs-full.png[image:../../images_www/v7/3/features/ide-analysis-main-cut.png[][font-11]#Clique na imagem para exibição em tela inteira#]
...
link:../../kb/docs/java/testng-screencast.html[Vídeo do Uso do TestNG no NetBeans IDE]     [overview-left]#link:../../images_www/v7/3/features/ide-findbugs-full.png[image:../../images_www/v7/3/features/ide-findbugs-cut.png[]]#
