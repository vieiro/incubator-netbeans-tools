...
link:../../images_www/v7/1/screenshots/debugger.png[image:../../images_www/v7/1/screenshots/debugger-cut.png[][font-11]# Click image for fullscreen preview#]
...
link:../../kb/docs/java/debug-visual.html[Using the Visual Debugger in NetBeans IDE]     [overview-right]#link:../../images_www/v7/3/features/profiler.png[image:../../images_www/v7/3/features/profiler-cut.png[]]#
