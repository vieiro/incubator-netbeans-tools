...
link:../../images_www/v7/1/screenshots/debugger.png[image:../../images_www/v7/1/screenshots/debugger-cut.png[][font-11]# 单击图像查看全屏预览#]
...
link:../../kb/docs/java/debug-visual.html[在 NetBeans IDE 中使用可视调试器]     [overview-right]#link:../../images_www/v7/3/features/profiler.png[image:../../images_www/v7/3/features/profiler-cut.png[]]#
