...
link:../../images_www/v7/1/screenshots/gui-builder.png[image:../../images_www/v7/1/screenshots/gui-builder-cut.png[][font-11]#イメージをクリックして全画面表示#]

*間隔や位置揃えの自動調整により、高度なGUIを作成できます。*

|===
|=== プロフェッショナルなSwing GUIのビルドimage:../../images_www/v6/features/improved_small.gif[]
...
|=== ビジュアル・デバッガimage:../../images_www/v6/features/improved_small.gif[]
...
image:../../images_www/v6/arrow-button.gif[] link:../../kb/trails/matisse.html[GUIビルダーの学習]
