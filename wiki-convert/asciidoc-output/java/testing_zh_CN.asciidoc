...
link:../../images_www/v7/3/features/ide-findbugs-full.png[image:../../images_www/v7/3/features/ide-analysis-main-cut.png[][font-11]#单击图像查看全屏预览#]
...
link:../../kb/docs/java/testng-screencast.html[在 NetBeans IDE 中使用 TestNG 的视频]     [overview-left]#link:../../images_www/v7/3/features/ide-findbugs-full.png[image:../../images_www/v7/3/features/ide-findbugs-cut.png[]]#
