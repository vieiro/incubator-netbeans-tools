...
link:../../images_www/v7/screenshots/java-se.png[image:../../images_www/v7/screenshots/java-se-cut1.png[][font-11]#单击图像查看全屏预览#]
...
image:../../images_www/v6/arrow-button.gif[] link:../../kb/trails/java-se.html[基本 IDE 和 Java 编程学习资源]

image:../../images_www/v6/arrow-button.gif[] link:../../kb/trails/platform.html[NetBeans 平台学习资源]
