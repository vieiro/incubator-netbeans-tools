...
link:../../images_www/v7/1/screenshots/debugger.png[image:../../images_www/v7/1/screenshots/debugger-cut.png[][font-11]# Для перехода к полноэкранному предварительному просмотру щелкните изображение#]
...
link:../../kb/docs/java/debug-visual.html[Использование визуального отладчика в IDE NetBeans]     [overview-right]#link:../../images_www/v7/3/features/profiler.png[image:../../images_www/v7/3/features/profiler-cut.png[]]#
