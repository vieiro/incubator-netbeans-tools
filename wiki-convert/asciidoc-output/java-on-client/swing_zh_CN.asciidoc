...
link:../../images_www/v7/3/features/client-swing-main-full.png[image:client-swing-main-cut.png[][font-11]#单击图像查看全屏预览#]
...
link:../../kb/docs/java/gui-builder-screencast.html[在 NetBeans IDE 中设计 Swing GUI]     [overview-left]#link:../../images_www/v7/3/features/client-swing-palette-full.png[image:client-swing-palette-cut.png[]]#
