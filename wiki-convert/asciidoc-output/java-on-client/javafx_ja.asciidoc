...
link:../../images_www/v7/3/features/client-javafx-main-full.png[image:../../images_www/v7/3/features/client-javafx-main-cut.png[][font-11]#イメージをクリックして全画面表示#]
...
link:http://www.youtube.com/watch?v=EGEONliKWDk[Scene BuilderとNetBeans IDEの組合せ]     [overview-left]#link:../../images_www/v7/3/features/client-javafx-fxml-full.png[image:../../images_www/v7/3/features/client-javafx-fxml-cut.png[]]#
