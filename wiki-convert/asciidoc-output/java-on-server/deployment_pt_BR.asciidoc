...
link:../../images_www/v7/3/features/deploy-monitor.png[image:../../images_www/v7/3/features/deploy-monitor-cut.png[][font-11]#Clique na imagem para exibição em tela inteira#]
