...
link:../../images_www/v7/1/screenshots/web-app.png[image:../../images_www/v7/1/screenshots/web-app-cut.png[][font-11]#Для перехода к полноэкранному предварительному просмотру щелкните изображение#]
...
    [overview-right]#link:../../images_www/v7/3/features/java-ee-6-full.png[image:../../images_www/v7/3/features/java-ee-6-full-cut.png[]]#
...
     [overview-right]#link:../../images_www/v7/3/features/cdi-support.png[image:../../images_www/v7/3/features/cdi-support-cut.png[]]#
...
[overview-centre]#image:../../images_www/v7/1/features/javaee-serverdeploy.png[]#
