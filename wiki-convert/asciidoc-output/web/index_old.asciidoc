...
link:../../images_www/v7/1/screenshots/web-app-cut.png[image:../../images_www/v7/1/screenshots/web-app-cut.png[][font-11]#Click image for fullscreen preview#]
...
|===
|image:../../images_www/v6/arrow-button.gif[] link:java-ee.html[Java EE]
Use Java Persistence, Enterprise JavaBeans, Java Server Faces, Contexts and Dependency Injection and other Java EE technologies. |image:../../images_www/v6/arrow-button.gif[] link:web-app.html[Web Frameworks]
Rapidly build standards-based web applications using Spring, Struts, and Hibernate frameworks. |image:../../images_www/v6/arrow-button.gif[] link:web-services.html[Web Services]
