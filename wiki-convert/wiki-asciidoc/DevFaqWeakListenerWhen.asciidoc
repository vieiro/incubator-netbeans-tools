...
You should use a link:DevFaqWeakListener[WeakListener] any time you are adding a listener to an object, but there is no code - and possibly no opportunity - to explicitly remove it.
