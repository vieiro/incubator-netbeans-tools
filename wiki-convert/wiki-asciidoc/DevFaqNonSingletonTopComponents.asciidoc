...
* Delete the link:DevFaqWindowsWstcrefAndFriends[wstcrf] (&quot;window system TopComponent reference&quot;) XML file in that folder.  If your component class is `MyWindow` then that file will be named `MyWindowWstcrf.xml`
