...
FileObjects are _virtual files_ which live inside a link:DevFaqFileSystem[FileSystem ].  They
...
* `FileObjects` can have key-value pairs of ad-hoc link:DevFaqFileAttributes[attributes ] associated with them
