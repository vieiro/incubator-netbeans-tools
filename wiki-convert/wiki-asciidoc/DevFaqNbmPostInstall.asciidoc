...
=== How to specify post-install code in link:NBM[NBM]

link:NBM[NBM] allows to declare its own custom code in link:NBM[NBM] archive. This code is called-back by `Autoupdate/Updater` at the end of installation of link:NBM[NBM] into IDE.
...
|%IDE_USER% |user directory link:1[1] 
...
* Download and unzip a project link:Media:samplepostinstall_DevFaqNbmPostInstall.zip[samplepostinstall_DevFaqNbmPostInstall.zip]
...
1. download link:Media:org-netbeans-samplepostinstall_DevFaqNbmPostInstall.nbm[NBM]
