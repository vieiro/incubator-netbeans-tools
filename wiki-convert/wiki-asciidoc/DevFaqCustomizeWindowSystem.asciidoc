...
If you want to customize features of all windows you can use the following branding properties. (See for example link:DevFaqRenamingMenuItem[here] how NetBeans branding works.)
