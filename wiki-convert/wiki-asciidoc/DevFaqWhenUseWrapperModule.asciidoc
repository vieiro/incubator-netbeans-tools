...
* Then you probably just want to package the library directly into your module, as in link:DevFaqModuleDependencies[DevFaqModuleDependencies]
...
* Else, you probably want to read link:DevFaqWrapperModules[DevFaqWrapperModules]
...
See link:DevFaqWrapperModules[Using a wrapper module for an existing project]
