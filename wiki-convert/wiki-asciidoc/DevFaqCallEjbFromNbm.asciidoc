...
*Important:* Application Client must be created as it is described in link:DevFaqAppClientOnNbPlatformTut[Java EE Application Client on top of the NetBeans Platform Tutorial] otherwise this will not work
