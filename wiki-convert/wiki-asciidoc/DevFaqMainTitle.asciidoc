...
As of NetBeans 6.9, it is possible to use the link:NewAndNoteWorthy#Branding_Editor[Branding Editor] to edit this resource.
...
* link:DevFaqVersionNumber[DevFaqVersionNumber]
