...
An easier place to search is the Online Help section of the latest Documentation Table, such as link:NB71DocumentationTable#OnlineHelp_Updates[NB71DocumentationTable#OnlineHelp_Updates].
