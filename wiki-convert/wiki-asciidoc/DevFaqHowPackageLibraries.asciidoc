...
you will want to use a wrapper module (see link:DevFaqWrapperModules[DevFaqWrapperModules]).
...
* link:PackagingADistributableJavaApp[Packaging A Distributable Java App]
* link:DevFaqHowPackageLibraries_DE[German version]
