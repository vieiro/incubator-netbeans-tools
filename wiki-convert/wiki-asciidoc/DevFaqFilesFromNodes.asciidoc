...
In general, it shall be enough to request a link:FileObject[FileObject] via link:Lookup[Lookup]:
...
Also see link:DevFaqFileVsFileObject[DevFaqFileVsFileObject] if you need `java.io.File` for some reason.
