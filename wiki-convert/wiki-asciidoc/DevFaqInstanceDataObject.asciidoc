...
So, code to actually get an instance of an object declared in the system filesystem  (link:DevFaqSystemFilesystem[DevFaqSystemFilesystem]) would look like this (plus error checking):
...
See also: link:DevFaqDotSettingsFiles[DevFaqDotSettingsFiles]
