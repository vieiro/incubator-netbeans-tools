...
* Subclass of link:DevFaqWindowsTopComponent[TopComponent] is created. Design it just as you would a JPanel.
* Simple subclass of `javax.swing.AbstractAction` in created and link:DevFaqActionAddMenuBar[added to main menu]. It's implemented it to open your component like follows:
[source,java]
----
...
* Declarative XML descriptions of component are created following link:DevFaqWindowsWstcrefAndFriends[declarative XML API] principles.
