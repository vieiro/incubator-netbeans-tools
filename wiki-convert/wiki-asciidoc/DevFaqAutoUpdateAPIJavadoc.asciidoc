...
* link:FaqPluginManagerCustomization[How to customize Plugin Manager?]
* link:DevFaqNbmPostInstall[How to specify post-install code in NBM?]
* link:FaqDevComponentWithCustomInstaller[How to install components using its custom installers?]
